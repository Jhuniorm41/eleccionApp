        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            return Padding(
              ...
              child: ListTile(
                title: Text(quest, style: Style.commonTextStyle),trailing: IconButton(
                  icon: Icon(Icons.photo, color: Color(0xFF56cfdf)),
                  iconSize: 18.0, onPressed: () {},),
